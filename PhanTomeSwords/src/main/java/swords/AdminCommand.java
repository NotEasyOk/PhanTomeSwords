    ...
    public boolean onCommand(CommandSender s, Command c, String l, String[] a) {
        ...
        if (a.length > 0) {
            ...
            if (a[0].equalsIgnoreCase("checkrecipe") && a.length >= 2) {
                ...
                List<String> slots = PhanTomCore.get().getConfig().getStringList("swords." + type + ".recipe_slots");
                if (!slots.isEmpty()) {
    ...
    public List<String> onTabComplete(CommandSender s, Command c, String l, String[] a) {
        ...
        if (a.length == 1) {
            ...
            if (a[0].equalsIgnoreCase("give")) {
                ...
                completions.addAll(PhanTomCore.get().getConfig().getConfigurationSection("swords").getKeys(false));
            }
